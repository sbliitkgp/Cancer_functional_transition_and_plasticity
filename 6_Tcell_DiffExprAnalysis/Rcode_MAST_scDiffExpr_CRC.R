...
data = fread('../../MLmodel2/MLdata_TNK/Merged_DomT_data_AllSamples_CRC.csv',data.table=F)
...
pdf(file = '../results_DiffExprAnalysis/MAST/CRC_Tdiff_PCA.pdf',useDingbats=F)
pr = plotPCA(scaRaw)
print(pr)
dev.off()
...
pdf(file = '../results_DiffExprAnalysis/MAST/CRC_Tdiff_20genes_distr.pdf',useDingbats=F)
print(pr)
dev.off()
...
write.table(fcHurdleSig,file = '../results_DiffExprAnalysis/MAST/CRC_Tdiff_DEresults.txt',quote=F)
...
pdf(file = '../results_DiffExprAnalysis/MAST/CRC_Tdiff_topGenes.pdf',useDingbats=F)
print(pr)
dev.off()
...
pdf(file = '../results_DiffExprAnalysis/MAST/CRC_Tdiff_Prportion_vs_Mean.pdf',useDingbats=F)
print(pr)
dev.off()
...
pdf(file = '../results_DiffExprAnalysis/MAST/CRC_Tdiff_heatmap_DEgenes.pdf',useDingbats=F) 
...
write.table(gseaTable, file = '../results_DiffExprAnalysis/MAST/CRC_Tdiff_GSEA_enriched_fns.txt',quote=F)


pdf(file = '../results_DiffExprAnalysis/MAST/CRC_Tdiff_top10_enriched_modules.pdf',useDingbats=F) 
