...
# Please give the folder path of the sample where it's ParTI output is present
setwd(path_env)
path_env <- "/data/subhasis_backup/subhasis/pipeline_testing/parti_result/SMC02-T/" 
library(R.matlab)
library(flexclust)
...
#put your destination folder directory path here
export_path <- "/data/subhasis_backup/subhasis/pipeline_testing/distance_and_ordering"  
