...
#  Run the Python script and capture its output. Please mention the sample name in the python script "code5.3_distance_cutoff_automate_main_5archetypes.py" before running this R script
...
# Please put your sample names here and this name should match with the sample name you provided in "code5.3_distance_cutoff_automate_main_5archetypes.py"
sample_name <- "SMC21-T" 
