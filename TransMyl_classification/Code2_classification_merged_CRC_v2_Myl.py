...
print('Reading data ...')
data=pd.read_csv("../MLdata_Myl_CRC/Merged_myeloid_data.csv")
#print(data)
...
data_cleaned = data_cleaned.loc[data_cleaned['label'] != 'Myl_DomStr']
...
wrname = '../results_Merged_Myl/Results_MLrun_Merged_CRC_run_XGB.txt'
wrf = open(wrname,'w')
...
feature_importance.to_csv('../results_Merged_Myl/CRC_Myl_FeatureImp_XGB_Native.tsv',sep='\t',index=False)
...
feature_importance.to_csv('../results_Merged_Myl/CRC_Myl_FeatureImp_XGB_Perm.tsv',sep='\t',index=False)
...
feature_importance.to_csv('../results_Merged_Myl/CRC_Myl_FeatureImp_XGB_SHAP.tsv',sep='\t',index=False)
...
wrname = '../results_Merged_Myl/Results_MLrun_Merged_CRC_run_RF.txt'
wrf = open(wrname,'w')
...
feature_importance.to_csv('../results_Merged_Myl/CRC_Myl_FeatureImp_RF_Native.tsv',sep='\t',index=False)
...
feature_importance.to_csv('../results_Merged_Myl/CRC_Myl_FeatureImp_RF_Perm.tsv',sep='\t',index=False)
...
feature_importance.to_csv('../results_Merged_Myl/CRC_Myl_FeatureImp_RF_SHAP.tsv',sep='\t',index=False)
...
wrname = '../results_Merged_Myl/Results_MLrun_Merged_CRC_run_LogReg.txt'
wrf = open(wrname,'w')
...
feature_importance.to_csv('../results_Merged_Myl/CRC_Myl_FeatureImp_LogReg_Perm.tsv',sep='\t',index=False)
