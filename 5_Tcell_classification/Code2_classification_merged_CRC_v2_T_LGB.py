...
wrname = '../results_MergedTNK/Results_MLrun_Merged_CRC_run_LGB.txt'
wrf = open(wrname,'w')
...
feature_importance.to_csv('../results_MergedTNK/CRC_T_FeatureImp_LGB_Perm.tsv',sep='\t',index=False)
...
feature_importance.to_csv('../results_MergedTNK/CRC_T_FeatureImp_LGB_SHAP.tsv',sep='\t',index=False)
