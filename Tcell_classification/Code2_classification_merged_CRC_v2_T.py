...
print('Reading data ...')
data=pd.read_csv("../MLdata_TNK/Merged_DomT_data_AllSamples_CRC.csv")
#print(data)
...
wrname = '../results_MergedTNK/Results_MLrun_Merged_CRC_run_XGB.txt'
wrf = open(wrname,'w')
...
feature_importance.to_csv('../results_MergedTNK/CRC_T_FeatureImp_XGB_Native.tsv',sep='\t',index=False)
...
feature_importance.to_csv('../results_MergedTNK/CRC_T_FeatureImp_XGB_Perm.tsv',sep='\t',index=False)
...
feature_importance.to_csv('../results_MergedTNK/CRC_T_FeatureImp_XGB_SHAP.tsv',sep='\t',index=False)
...
wrname = '../results_MergedTNK/Results_MLrun_Merged_CRC_run_RF.txt'
wrf = open(wrname,'w')
...
feature_importance.to_csv('../results_MergedTNK/CRC_T_FeatureImp_RF_Native.tsv',sep='\t',index=False)
...
feature_importance.to_csv('../results_MergedTNK/CRC_T_FeatureImp_RF_Perm.tsv',sep='\t',index=False)
...
feature_importance.to_csv('../results_MergedTNK/CRC_T_FeatureImp_RF_SHAP.tsv',sep='\t',index=False)
...
wrname = '../results_MergedTNK/Results_MLrun_Merged_CRC_run_LogReg.txt'
wrf = open(wrname,'w')
...
feature_importance.to_csv('../results_MergedTNK/CRC_T_FeatureImp_LogReg_Perm.tsv',sep='\t',index=False)
