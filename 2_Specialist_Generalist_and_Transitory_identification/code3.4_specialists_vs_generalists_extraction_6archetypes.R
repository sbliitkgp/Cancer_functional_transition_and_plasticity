...
# Run the Python script and capture its output. Please mention the sample name in the python script "code5.4_distance_cutoff_automate_main_6archetypes.py" before running this R script
output <- system2("python", args = c("../../pipeline_testing/codes/code5.4_distance_cutoff_automate_main_6archetypes.py"), stdout = TRUE)
...
# Please put your sample names here and this name should match with the sample name you provided in "code5.4_distance_cutoff_automate_main_6archetypes.py"
sample_name <- "SMC08-N"  
...
all_specialists<-list(specialist_a1_gene_exp,specialist_a2_gene_exp,specialist_a3_gene_exp,specialist_a4_gene_exp,specialist_a5_gene_exp, specialist_a6_gene_exp)
...
all_specialists_gene_exp <- cbind(all_specialists[[1]],all_specialists[[2]],all_specialists[[3]],all_specialists[[4]],all_specialists[[5]], all_specialists[[6]])
