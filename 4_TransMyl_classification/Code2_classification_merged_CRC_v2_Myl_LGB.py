...
wrname = '../results_Merged_Myl/Results_MLrun_Merged_CRC_run_LGB.txt'
wrf = open(wrname,'w')
...
feature_importance.to_csv('../results_Merged_Myl/CRC_Myl_FeatureImp_LGB_Perm.tsv',sep='\t',index=False)
...
feature_importance.to_csv('../results_Merged_Myl/CRC_Myl_FeatureImp_LGB_SHAP.tsv',sep='\t',index=False)
