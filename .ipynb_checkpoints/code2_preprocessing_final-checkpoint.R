...
#Please give your full path to samples folder where the metadata and gene expression data is present
path <- "/data/subhasis_backup/subhasis/pipeline_testing/data/SMC01-T" 
setwd(path)
library(dplyr)
library(stringr)
library(Seurat)
